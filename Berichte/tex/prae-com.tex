...
\numberwithin{figure}{section}                                      % Abschnittsnummer in Abbildungsbeschriftung
\numberwithin{table}{section}                                       % Abschnittsnummer in Tabellenbeschriftung
\numberwithin{equation}{section}                                    % Abschnittsnummer in Formelbeschriftung
...
\usepackage{lastpage}                                               % Zähler für Angabe der letzten Seite
...
\lohead{\normalfont \VarTitelueberschrift\\\VarTitel}
\rohead{\normalfont \VarVerfasserIn\\\VarDatumVersion}
\cfoot[\pagemark]{\normalfont Seite \textbf{\thepage} von \textbf{\pageref{LastPage}}}
...
\newcommand{\Titelueberschrift}[1]{
    \def\VarTitelueberschrift{#1}
}
\newcommand{\Titel}[1]{
    \def\VarTitel{#1}
}
...
\newcommand{\TeilnehmerIn}[3][Teilnehmer:in]{
    \def\VarBezTeilnehmerIn{#1}%
    \def\VarTeilnehmerIn{#2}%
    \def\VarTeilnehmerInMatNr{#3}
}
\newcommand{\TeilnehmerInB}[3][Teilnehmer:in]{
    \def\VarBezTeilnehmerInB{#1}%
    \def\VarTeilnehmerInB{#2}%
    \def\VarTeilnehmerInMatNrB{#3}%
    \toggletrue{ZweiTeilnehmerInnen}
}
\newcommand{\DatumVersuch}[2][Versuchsdurchführung]{
    \def\VarBezDatumVersuch{#1}%
    \def\VarDatumVersuch{#2}
}
\newcommand{\DatumAbgabe}[2][Abgabe des Berichts]{
...
\newtoggle{VerfasserInTeilnehmerInLeerzeile}
\newcommand{\VerfasserInTeilnehmerInLeerzeile}{
    \toggletrue{VerfasserInTeilnehmerInLeerzeile}
}
\newtoggle{ZweiTeilnehmerInnen}
\newtoggle{DatumLeerzeile}
\newcommand{\DatumLeerzeile}{
    \toggletrue{DatumLeerzeile}
}
\newtoggle{BetreuerInLeerzeile}
\newcommand{\BetreuerInLeerzeile}{
    \toggletrue{BetreuerInLeerzeile}
}
